...
class VolunteersControllerTest < ActionController::TestCase
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post :create, volunteer: { contact_number: @volunteer.contact_number, first_name: @volunteer.first_name, last_name: @volunteer.last_name, notes: @volunteer.notes }
    end
  ...
  test "should update volunteer" do
    patch :update, id: @volunteer, volunteer: { contact_number: @volunteer.contact_number, first_name: @volunteer.first_name, last_name: @volunteer.last_name, notes: @volunteer.notes }
    assert_redirected_to volunteer_path(assigns(:volunteer))
  end
